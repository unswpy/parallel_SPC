...
echo "data 1 SPC index constructing"
#./u_index -g graph/1.txt -l label/1.txt -b n -o degree -t $1
./u_index -g graph/$1 -l label/$1 -o degree -s y -e y -i y -t $2

echo $1
echo "data 1 SPC querying"
./u_query -l label/$1 -q query/$1 -a answer/$1 -g $1 -t o
echo "-----------------------------------------------------"
